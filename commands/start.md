...
**macOS/Linux:**
```bash
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.16.0/auto-resume-daemon.js start
```
...
**macOS/Linux:**
```bash
nohup node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.16.0/auto-resume-daemon.js start > /dev/null 2>&1 &
```
