...
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.8.1/auto-resume-daemon.js test $ARGUMENTS

# Default 10 seconds
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.8.1/auto-resume-daemon.js test 10
```
