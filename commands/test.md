...
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.4.17/auto-resume-daemon.js test $ARGUMENTS

# Default 10 seconds
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.4.17/auto-resume-daemon.js test 10
```
