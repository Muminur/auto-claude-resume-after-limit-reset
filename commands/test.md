...
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.20.0/auto-resume-daemon.js test $ARGUMENTS

# Default 10 seconds
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.20.0/auto-resume-daemon.js test 10
```

**Windows (PowerShell):**
```powershell
# With custom countdown (e.g., 30 seconds)
node "$env:USERPROFILE\.claude\plugins\cache\auto-claude-resume\auto-resume\1.20.0\auto-resume-daemon.js" test $ARGUMENTS

# Default 10 seconds
node "$env:USERPROFILE\.claude\plugins\cache\auto-claude-resume\auto-resume\1.20.0\auto-resume-daemon.js" test 10
```

**Windows (CMD/Git Bash):**
```cmd
node "%USERPROFILE%\.claude\plugins\cache\auto-claude-resume\auto-resume\1.20.0\auto-resume-daemon.js" test 10
```

> **Note:** When Claude Code executes these commands via Bash tool, use the direct Windows path:
> `node "C:\Users\YOUR_USERNAME\.claude\plugins\cache\auto-claude-resume\auto-resume\1.20.0\auto-resume-daemon.js" test $ARGUMENTS`
