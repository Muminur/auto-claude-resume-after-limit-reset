...
**macOS/Linux:**
```bash
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.7.0/auto-resume-daemon.js gui
```
...
- **macOS/Linux:** `~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.7.0/gui/index.html`
