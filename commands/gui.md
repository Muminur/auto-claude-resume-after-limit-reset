...
**macOS/Linux:**
```bash
node ~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.4.13/auto-resume-daemon.js gui
```
...
- **macOS/Linux:** `~/.claude/plugins/cache/auto-claude-resume/auto-resume/1.4.13/gui/index.html`
